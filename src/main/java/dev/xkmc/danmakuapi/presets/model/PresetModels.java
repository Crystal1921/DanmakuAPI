...
public class PresetModels {
	...
	public static final ModelLayerLocation RUMIA_LAYER = new ModelLayerLocation(DanmakuAPI.loc("rumia"), "main");

	public static LayerDefinition createRumia() {
	...
	public static final ModelLayerLocation REIMU_LAYER = new ModelLayerLocation(DanmakuAPI.loc("hakurei_reimu"), "main");

	public static LayerDefinition createReimu() {
		MeshDefinition meshdefinition = new MeshDefinition();
		PartDefinition partdefinition = meshdefinition.getRoot();
