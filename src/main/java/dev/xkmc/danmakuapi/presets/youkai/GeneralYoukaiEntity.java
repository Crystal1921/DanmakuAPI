...
public class GeneralYoukaiEntity extends YoukaiEntity {
	...
	private static final ResourceLocation DEFAULT_SPELL_CIRCLE = FastProjectileAPI.loc("test_spell");
	...
	protected boolean wouldAttack(LivingEntity entity) {
		...
		return entity.getType().is(EntityTypeTags.RAIDERS) || entity.getType().is(EntityTypeTags.UNDEAD);
	}
