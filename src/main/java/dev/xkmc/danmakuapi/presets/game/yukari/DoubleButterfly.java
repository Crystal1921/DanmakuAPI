...
public class DoubleButterfly extends ActualSpellCard {
	...
	public void tick(CardHolder holder) {
		...
		if (tick % interval == 0) {
			launch(holder, DanmakuItems.Bullet.BUTTERFLY, DyeColor.CYAN, 1);
			launch(holder, DanmakuItems.Bullet.BUTTERFLY, DyeColor.MAGENTA, -1);
		}
	}

	private void launch(CardHolder holder, DanmakuItems.Bullet type, DyeColor color, int dire) {
		var r = holder.random();
